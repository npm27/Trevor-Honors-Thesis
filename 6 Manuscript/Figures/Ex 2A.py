...
ax1.set_title('Experiment 2A: Font-Size', fontsize = 18, fontweight = 'bold')
ax1.set_ylabel('Mean % JOL/Recall', fontsize = 16)
ax1.set_xlabel('Direction', fontsize = 16)
ax1.xaxis.labelpad = 10
ax1.set_xticks(ind)
ax1.set_xticklabels(('Large', 'Small', 'Control'), fontsize = 14)
ax1.legend(fontsize = 14)
ax1.set_ylim([0,100])

##save figure
fig.savefig('EX2A_chart.png', dip = 10000)
