setwd("C:/Users/nickm.000/Documents/GitHub/Trevor-Honors-Thesis/1 Output/Ex2/Ex 2 Raw") #get the correct directory
...
dat2 = subset(dat,
              dat$Condition.Notes == "Size U A" | dat$Condition.Notes == "Size U B")
dat3 = subset(dat,
              dat$Condition.Notes == "Highlight U A" | dat$Condition.Notes == "Highlight U B")
...
write.csv(Large_vs_Small, file = "Ex 2 Scored Output/Size.csv", row.names = F)
write.csv(Highlight, file = "Ex 2 Scored Output/Highlight.csv", row.names = F)
