...
<div class="study">
    <span class="study-left-h" style = "background-color:#FFFF00" ><?php echo $cue;    ?></span>
    <span class="study-divider-h" style = "background-color:#FFFF00" ><?php echo ":";     ?></span>
    <span class="study-right-h" style = "background-color:#FFFF00" ><?php echo $answer; ?></span>
    <br>
